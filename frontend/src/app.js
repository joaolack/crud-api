...
import {
    enterEditMode, exitEditMode, getEditingId, getOriginalUser,
    getUserFromCard, showError, hideError,
...
form.addEventListener('submit', async (event) => {
    ...
    try {
        ...
        if (editingId !== null) {
            const result = await updateUser(apiUrl, editingId, user, getOriginalUser());
